...
#ifndef __DA_SEPARATE_V2_PMU_REG_DEF_H__
#define __DA_SEPARATE_V2_PMU_REG_DEF_H__

/* reg_codec Base address of Module's Register */
#define DA_SEPARATE_V2_PMU_CODEC_BASE                       (0x0)

/******************************************************************************/
/*                      DA_SEPARATE_V2 reg_codec Registers' Definitions                            */
/******************************************************************************/

#define CLK_EN_CFG_REG         (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x380) /*  ±÷” πƒ‹≈‰÷√ºƒ¥Ê∆˜°£ */
...
#define CLK_EDGE_CFG_REG       (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x381) /*  ˝ƒ£Ω”ø⁄ ±÷”—ÿ—°‘Ò°£ */
...
#define SIF_LOOPBACK_CFG_REG   (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x382) /* SIFΩ”ø⁄ª∑ªÿøÿ÷∆°£ */
#define ADC_LOOPBACK_LEN    2
#define ADC_LOOPBACK_OFFSET 2
#define DAC_LOOPBACK_LEN    2
#define DAC_LOOPBACK_OFFSET 0

#define DAC_CHAN_CTRL_REG      (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x383) /* DACÕ®¬∑≈‰÷√°£ */
...
#define ADC_CHAN_CTRL_REG      (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x384) /* ADCÕ®¬∑≈‰÷√°£ */
...
#define ANA_IRQ_SIG_STAT_REG   (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x385) /* ƒ£ƒ‚÷–∂œ‘≠ º◊¥Ã¨ºƒ¥Ê∆˜°£ */
...
#define ANA_IRQM_REG0_REG      (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x386) /* ANA_IRQ_REG÷–∂œ∆¡±Œºƒ¥Ê∆˜°£ */
#define ANA_IRQ_MASK_LEN    8
#define ANA_IRQ_MASK_OFFSET 0

#define ANA_IRQ_REG0_REG       (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x387) /* ƒ£ƒ‚÷–∂œºƒ¥Ê∆˜°£0£¨–¥1«Â£¨∂¡…œ±®÷–∂œ–≈œ¢°£ */
...
#define DEB_CNT_HS_DET_CFG_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x388) /* hs_det_irq»•∂∂≈‰÷√°£ */
...
#define DEB_CNT_HS_MIC_CFG_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x389) /* hs_mic_irq»•∂∂≈‰÷√°£ */
...
#define CODEC_ANA_RW1_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x38A) /* vref/ctcm/ibiasƒ£øÈ πƒ‹ */
#define CODEC_IBIAS_PD_LEN      1
#define CODEC_IBIAS_PD_OFFSET   2
#define CODEC_VREFSEL_LEN       2
#define CODEC_VREFSEL_OFFSET    0

#define CODEC_ANA_RW2_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x38B) /* micpga πƒ‹ */
...
#define CODEC_ANA_RW3_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x38C) /* adc πƒ‹ */
...
#define CODEC_ANA_RW4_REG      (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x38D) /* dac πƒ‹°£ */
...
#define CODEC_ANA_RW5_REG      (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x38E) /* headphone πƒ‹°£ */
...
#define CODEC_ANA_RW6_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x38F) /* earphone/lineout πƒ‹ */
...
#define CODEC_ANA_RW7_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x390) /* micbias πƒ‹ */
...
#define CODEC_ANA_RW8_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x391) /* mbhd πƒ‹ */
...
#define CODEC_ANA_RW9_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x392) /* mainpga≈‰÷√ */
...
#define CODEC_ANA_RW10_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x393) /* auxpga≈‰÷√ */
...
#define CODEC_ANA_RW11_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x394) /* mic3pga≈‰÷√ */
...
#define CODEC_ANA_RW12_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x395) /* adcl≈‰÷√ */
...
#define CODEC_ANA_RW13_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x396) /* adcl≈‰÷√ */
...
#define CODEC_ANA_RW14_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x397) /* adcr≈‰÷√ */
...
#define CODEC_ANA_RW15_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x398) /* adcr≈‰÷√ */
...
#define CODEC_ANA_RW16_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x399) /* adc3≈‰÷√ */
...
#define CODEC_ANA_RW17_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x39A) /* adc3≈‰÷√ */
...
#define CODEC_ANA_RW18_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x39B) /* dac≈‰÷√ */
...
#define CODEC_ANA_RW19_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x39C) /* chargepump≈‰÷√ */
...
#define CODEC_ANA_RW20_REG     (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x39D) /* hp mixer ‰»Î—°‘Ò°£ */
...
#define CODEC_ANA_RW21_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x39E) /* hp ‘ˆ“Ê—°‘Ò */
#define CODEC_HSL_GAIN_LEN    4
#define CODEC_HSL_GAIN_OFFSET 4
#define CODEC_HSR_GAIN_LEN    4
#define CODEC_HSR_GAIN_OFFSET 0

#define CODEC_ANA_RW22_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x39F) /* hp≈‰÷√ */
...
#define CODEC_ANA_RW23_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3A0) /* hp≈‰÷√ */
...
#define CODEC_ANA_RW24_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3A1) /* hp pop≈‰÷√ */
...
#define CODEC_ANA_RW25_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3A2) /* ep mixer≈‰÷√ */
...
#define CODEC_ANA_RW26_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3A3) /* earphone≈‰÷√ */
#define CODEC_EAR_CM_CTRL_LEN    1
#define CODEC_EAR_CM_CTRL_OFFSET 4
#define CODEC_EAR_GAIN_LEN       4
#define CODEC_EAR_GAIN_OFFSET    0

#define CODEC_ANA_RW27_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3A4) /* lineout≈‰÷√ */
...
#define CODEC_ANA_RW28_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3A5) /* himicbias≈‰÷√ */
...
#define CODEC_ANA_RW29_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3A6) /* micbias1≈‰÷√ */
...
#define CODEC_ANA_RW30_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3A7) /* micbias2≈‰÷√ */
...
#define CODEC_ANA_RW31_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3A8) /* ∂˙ª˙≤Â»ÎºÏ≤‚≈‰÷√ */
...
#define CODEC_ANA_RW32_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3A9) /* ∂˙ª˙∞Œ≥ˆpop≈‰÷√ */
...
#define CODEC_ANA_RW33_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3AA) /* mbhd ref≈‰÷√ */
...
#define CODEC_ANA_RW34_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3AB) /* adc/dac ±÷”—È≈‰÷√ */
...
#define CODEC_ANA_RW35_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3AC) /* rxÕ®¬∑chop ±÷”≈‰÷√ */
...
#define CODEC_ANA_RW36_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3AD) /* txÕ®¬∑chop ±÷”≈‰÷√ */
...
#define CODEC_ANA_RW37_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3AE) /* cp/pop ±÷”≈‰÷√ */
...
#define CODEC_ANA_RW38_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3AF) /* capless ±÷”≈‰÷√ */
...
#define CODEC_ANA_RW39_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3B0) /* ∆´÷√µÁ¡˜≈‰÷√ */
...
#define CODEC_ANA_RW40_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3B1) /* ∆´÷√µÁ¡˜≈‰÷√ */
...
#define CODEC_ANA_RW41_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3B2) /* ∆´÷√µÁ¡˜≈‰÷√ */
...
#define CODEC_ANA_RW42_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3B3) /* ∆´÷√µÁ¡˜≈‰÷√ */
...
#define CODEC_ANA_RW43_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3B4) /* ∆´÷√µÁ¡˜≈‰÷√ */
...
#define CODEC_ANA_RW44_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3B5) /* ∆´÷√µÁ¡˜≈‰÷√ */
...
#define CODEC_ANA_RW45_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3B6) /* ∆´÷√µÁ¡˜≈‰÷√ */
...
#define CODEC_ANA_RW46_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3B7) /* ∆´÷√µÁ¡˜≈‰÷√ */
...
#define CODEC_ANA_RW47_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3B8) /* ∆´÷√µÁ¡˜≈‰÷√ */
#define CODEC_IB05_MICB_ADJ_LEN    3
#define CODEC_IB05_MICB_ADJ_OFFSET 0

#define CODEC_ANA_RW48_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3B9) /* ∆´÷√µÁ¡˜≈‰÷√ */
...
#define CODEC_ANA_RW49_REG (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x3BA) /* ∆´÷√µÁ¡˜≈‰÷√ */
...
/******************************************************************************/
/*                      DA_SEPARATE_V2 ctrl Registers' Definitions                            */
/******************************************************************************/
#define CTRL_REG_CLASSD_CTRL0_REG               (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x109)
...
#define CTRL_REG_CLASSD_CTRL1_REG               (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x10A)
...
#define CTRL_REG_CLASSD_CTRL2_REG               (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x10B)
...
#define CTRL_REG_CLASSD_CTRL3_REG               (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x10C)
#define CTRL_REG_CLASSD_RESERVE1_LEN    8
#define CTRL_REG_CLASSD_RESERVE1_OFFSET 0


#define CTRL_REG_PMU_SOFT_RST_REG        (DA_SEPARATE_V2_PMU_CODEC_BASE + 0x10D) /* PMU»Ì∏¥Œªºƒ¥Ê∆˜°£ */
#define CTRL_REG_SOFT_RST_N_LEN    8
#define CTRL_REG_SOFT_RST_N_OFFSET 0

#endif /* __DA_SEPARATE_V2_PMU_REG_DEF_H__ */
