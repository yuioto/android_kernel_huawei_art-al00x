...
typedef union {
    struct {
        ...
        unsigned int Reserved_689 : 1 ;
        unsigned int smr_ptw_qos : 2 ;
        unsigned int smr_invld_en : 1 ;
        unsigned int Reserved_688 : 7 ;
...
typedef union {
    struct {
        ...
        unsigned int Reserved_693 : 9 ;
        unsigned int cb_ttbcr_t1sz : 3 ;
        unsigned int Reserved_692 : 13 ;
    } bits;
    unsigned int u32;
} U_SMMU_CB_TTBCR;
typedef union {
...
typedef union {
    struct {
        ...
        unsigned int Reserved_703 : 14 ;
        unsigned int dbg_tlb_type : 1 ;
        unsigned int Reserved_702 : 1 ;
    } bits;
    unsigned int u32;
} U_SMMU_DBGRPTR_TLB;
typedef union {
...
typedef union {
    struct {
        unsigned int Reserved_727 : 1 ;
        unsigned int override_va_security : 1 ;
        unsigned int Reserved_726 : 30 ;
    } bits;
    unsigned int u32;
...
typedef union {
    struct {
        ...
        unsigned int Reserved_729 : 1 ;
        unsigned int smr_bypass_p : 1 ;
        unsigned int Reserved_728 : 9 ;
