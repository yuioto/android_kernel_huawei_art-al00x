...
/* NVRAM中存储的参数值的总个数:每项power值对应一项scale，加上dpd开关 */
...
#define RF_TXPWR_CALI_REF_2G_VAL_BAND1_EVB0 (98)
#define RF_TXPWR_CALI_REF_2G_VAL_BAND2_EVB0 (108)
#define RF_TXPWR_CALI_REF_2G_VAL_BAND3_EVB0 (118)

#define PHY_DBB_SCALING_11B_EVB0               (0x9C9C9C9C)
#define PHY_U1_SCALING_VALUE_11G_EVB0          (0x70707070)
#define PHY_U2_SCALING_VALUE_11G_EVB0          (0x66707070)
#define PHY_U1_SCALING_VALUE_11N_2D4G_EVB0     (0x57575757)
#define PHY_U2_SCALING_VALUE_11N_2D4G_EVB0     (0x5c5c5757)
#define PHY_U1_SCALING_VALUE_11N40M_2D4G_EVB0  (0x60606060)
#define PHY_U2_SCALING_VALUE_11N40M_2D4G_EVB0  (0x63636060)
#define PHY_U0_SCALING_VALUE_11N_5G_EVB0       (0x303a)
#define PHY_U3_SCALING_VALUE_11N40M_5G_EVB0    (0x3038)
...
typedef enum {
    ...
    /* STA DTIM参数配置 */
    WLAN_CFG_INIT_STA_DTIM_SETTING,
    /* 可维可测 */
    ...
    /* PHY DBB SCALING */
    WLAN_CFG_INIT_PHY_SCALING_VALUE_11B,
    WLAN_CFG_INIT_PHY_U1_SCALING_VALUE_11G,
    WLAN_CFG_INIT_PHY_U2_SCALING_VALUE_11G,
    WLAN_CFG_INIT_PHY_U1_SCALING_VALUE_11N_2D4G,
    WLAN_CFG_INIT_PHY_U2_SCALING_VALUE_11N_2D4G,
    WLAN_CFG_INIT_PHY_U1_SCALING_VALUE_11N40M_2D4G,
    WLAN_CFG_INIT_PHY_U2_SCALING_VALUE_11N40M_2D4G,
    WLAN_CFG_INIT_PHY_U0_SCALING_VALUE_11N_5G,
    WLAN_CFG_INIT_PHY_U3_SCALING_VALUE_11N40M_5G,
    WLAN_CFG_INIT_PHY_SCALING_END = WLAN_CFG_INIT_PHY_U3_SCALING_VALUE_11N40M_5G,
    /* 时钟信息 */
    WLAN_CFG_INIT_RTS_CLK_FREQ,
    WLAN_CFG_INIT_CLK_TYPE,
    /* 2G RF前端 */
    WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND1, // 39
    WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND2,
    WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND3,
#if 0
...
#endif
    /* 2G RF Tx POWER REF值 */
    WLAN_CFG_INIT_RF_TXPWR_CALI_REF_2G_VAL_BAND1,
    WLAN_CFG_INIT_RF_TXPWR_CALI_REF_2G_VAL_BAND2,
    WLAN_CFG_INIT_RF_TXPWR_CALI_REF_2G_VAL_BAND3,
    /* 5G RF前端 */
    ...
    /* FCC认证 */
    WLAN_CFG_INIT_BAND_EDGE_LIMIT_2G_11G_TXPWR,                        /* FCC CH1,CH11 band edge limit */      // 21
    /* FCC认证:TXPWR 起始配置ID */
    WLAN_CFG_INIT_BAND_EDGE_LIMIT_TXPWR_START = WLAN_CFG_INIT_BAND_EDGE_LIMIT_2G_11G_TXPWR,
    WLAN_CFG_INIT_BAND_EDGE_LIMIT_2G_11N_HT20_TXPWR,                   /* FCC CH1,CH11 band edge limit */
    WLAN_CFG_INIT_BAND_EDGE_LIMIT_2G_11N_HT40_TXPWR,
    WLAN_CFG_INIT_BAND_EDGE_LIMIT_2G_11G_DBB_SCALING,                  /* FCC CH1,CH11 dbb scaling */
    /* FCC认证:SCALE 起始配置ID */
    WLAN_CFG_INIT_BAND_EDGE_LIMIT_SCALE_START = WLAN_CFG_INIT_BAND_EDGE_LIMIT_2G_11G_DBB_SCALING,
    WLAN_CFG_INIT_BAND_EDGE_LIMIT_2G_11N_HT20_DBB_SCALING,             /* FCC CH1,CH11 dbb scaling */
    WLAN_CFG_INIT_BAND_EDGE_LIMIT_2G_11N_HT40_DBB_SCALING,
    WLAN_CFG_INIT_PMF_ENABLE, /* pmf开关 */

    WLAN_CFG_INIT_RSSI_DESCEND_PROTOCOL_LIMIT,

    WLAN_CFG_INIT_HIGH_POWER_SWITCH, /* 高功耗版本开关 */

#ifdef _PRE_WLAN_FEATURE_1131K_BTCOEX
    WLAN_CFG_INIT_BTCOEX_CHANNEL_SWITCH,
#endif
...
extern oal_int8 *hwifi_get_country_code(void);
extern void hwifi_set_country_code(const int8_t *country_code, const uint32_t len);
extern int hwifi_get_mac_addr(unsigned char *);
#if (_PRE_PRODUCT_ID != _PRE_PRODUCT_ID_HI1131C_HOST)
extern unsigned char *hwifi_get_nvram_params(void);
#endif
extern oal_int32 hwifi_recover_ini_gloabal(void);
