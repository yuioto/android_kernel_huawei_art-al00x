...
#define GPIO_HOST_TO_DEVICE                  211
#define GPIO_PMU_PWRON                       8
#define GPIO_WL_RST_N                        7
...
/* hisi_cust_cfg */
#define DTS_NODE_HISI_CUST                  "hi110x,customize"
#define DTS_NODE_INI_FILE_NAME              "ini_file_name"

#define DTS_NODE_HI110X                     "hisilicon,hi110x"
...
#define DTS_PROP_GPIO_POWEN_ON              "hi110x,gpio_power_on"
#define DTS_PROP_GPIO_WLAN_WAKEUP_HOST      "hi110x,gpio_wlan_wakeup_host"
#define DTS_DROP_GPIO_WLAN_POWER_ON         "hi110x,gpio_wlan_power_on"
#define DTS_DROP_GPIO_HOST_TO_DEVICE        "hi110x,gpio_host_to_device"
...
#define WL_RST_DELAY                30 // rst pull high delay
/*****************************************************************************
  3 STRUCT DEFINE
*****************************************************************************/
...
extern int32_t get_ini_file_name_from_dts(int8_t *dts_prop, int8_t *prop_value, uint32_t size);
