...
extern oal_uint32 oal_crypto_bip_enmic(oal_uint8 uc_igtk_keyid, oal_uint8 *pst_igtk_key, oal_uint8 *pst_igtk_seq,
                                       oal_netbuf_stru *pst_netbuf, oal_uint16 *pst_frame_len);
#endif
extern oal_uint32 oal_crypto_bip_demic(oal_uint8 uc_igtk_keyid, oal_uint8 *pst_igtk_key, oal_uint8 *pst_igtk_seq,
                                       oal_netbuf_stru *pst_netbuf, oal_uint32 *pul_dot11RSNAStatsCMACReplays,
                                       oal_uint32 *pul_dot11RSNAStatsCMACICVErrors);
