...
extern oal_cfg80211_bss_stru *oal_cfg80211_get_bss(oal_wiphy_stru *wiphy,
                                                   oal_ieee80211_channel_stru *channel,
                                                   uint8_t *bssid,
                                                   uint8_t *ssid,
                                                   uint32_t ssid_len);
extern void oal_cfg80211_unlink_bss(oal_wiphy_stru *wiphy, oal_cfg80211_bss_stru *cfg80211_bss);
...
extern oal_uint32 oal_cfg80211_rx_mgmt(
    ...
    oal_uint32            ul_len,
    oal_gfp_enum_uint8    en_gfp);
extern oal_void oal_cfg80211_ready_on_channel(
...
extern oal_void oal_cfg80211_mgmt_tx_status(
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 10, 44))\
            || (_PRE_OS_VERSION_LITEOS == _PRE_OS_VERSION)\
...
extern uint32_t oal_cfg80211_rx_exception(oal_net_device_stru *netdev,
    uint8_t *data, uint32_t data_len);
extern oal_uint32  oal_cfg80211_init(oal_void);
extern oal_void  oal_cfg80211_exit(oal_void);
extern int32_t oal_cfg80211_external_auth_request(oal_net_device_stru *netdev,
