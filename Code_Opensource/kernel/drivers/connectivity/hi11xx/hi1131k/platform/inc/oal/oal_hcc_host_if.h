...
#define HCC_TX_HI_QUEUE_TRANS_LIMIT     64
#define HCC_TX_LO_QUEUE_TRANS_LIMIT     10
...
oal_int32 oal_hcc_rx_req_1st_info(void* channel);
...
extern oal_int32 hcc_rx_register(struct hcc_handler *hcc, oal_uint8 mtype, hcc_rx_post_do post_do,
                                 hcc_rx_pre_do pre_do);
...
{
    struct hcc_tx_cb_stru* pst_cb_stru = OAL_PTR_NULL;
