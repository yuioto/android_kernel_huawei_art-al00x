...
#ifndef __PLATFORM_SPEC_1131C_H__
#define __PLATFORM_SPEC_1131C_H__
...
#else
#define WLAN_MEM_MAX_SUBPOOL_NUM            4
#endif /* _PRE_LITEOS_WLAN_FEATURE_MEM_REDUCE */
#endif
...
#ifndef WIN32
#define WLAN_MEM_SHARED_RX_DSCR_CNT         0              /* 接收512(数据帧描述符) + 64(管理帧描述符) */ /* 注意! 新增一个子内存池要更新oal_mem.c里的OAL_MEM_BLK_TOTAL_CNT */
#define WLAN_MEM_SHARED_TX_DSCR_SIZE1       84              /* 比实际发送描述符结构体稍大些，预留出后面对发送描述符的修改 */
#define WLAN_MEM_SHARED_TX_DSCR_CNT1        0             /* 发送描述符512 */
#else
...
#define WLAN_MEM_SHARED_DATA_PKT_CNT        0               /* skb(接收的帧头个数) + 发送描述符个数(发送的帧头个数) 768 */
...
#define WLAN_MEM_LOCAL_CNT2                 20             /* 200(杂用) */
#endif
...
#else
#define WLAN_MEM_LOCAL_CNT3                 50
#endif /* _PRE_LITEOS_WLAN_FEATURE_MEM_REDUCE */
#endif

#define WLAN_MEM_LOCAL_SIZE4                512             /* 长度为128的事件队列用 */
#ifndef _PRE_LITEOS_WLAN_FEATURE_MEM_REDUCE
#define WLAN_MEM_LOCAL_CNT4                 40
#else
#define WLAN_MEM_LOCAL_CNT4                 8
#endif

#ifndef _PRE_LITEOS_WLAN_FEATURE_MEM_REDUCE
#define WLAN_MEM_LOCAL_SIZE5                4304
#define WLAN_MEM_LOCAL_CNT5                 20
#else
#define WLAN_MEM_LOCAL_SIZE5                2000
#define WLAN_MEM_LOCAL_CNT5                 6
#endif
...
#if (_PRE_OS_VERSION_RAW == _PRE_OS_VERSION) || (_PRE_OS_VERSION_WIN32_RAW == _PRE_OS_VERSION)
/* 裸系统对应本地内存个数 */
#define WLAN_MEM_EVENT_CNT1                 100
...
*****************************************************************************/
#define WLAN_MEM_MIB_SIZE1                  1240           /* mib结构体大小 */
...
#define WLAN_FRW_EVENT_CFG_TABLE_PER_VAP \
    ...
    {   1,               64,                      1, 0 },      /* WLAN_CTX */ \
    {   1,               64,                      1, 0 },      /* WLAN_DTX */ \
    {   1,                0,                      1, 0 },      /* WLAN_TX_COMP */ \
    {   1,                0,                      1, 0 },      /* TBTT */ \
    {   1,                2,                      1, 0 },      /* TIMEOUT */ \
    {   1,                0,                      1, 0 },      /* HMAC MISC */ \
    {   1,               64,                      0, 0 },      /* DMAC MISC */ \
    {   1,               128,                     1, 0},     /* HMAC_HCC_TEST */
/* Host */
#define WLAN_FRW_EVENT_CFG_TABLE \
    { \
...
#endif /* #ifndef __PLATFORM_SPEC_1131C_H__ */
