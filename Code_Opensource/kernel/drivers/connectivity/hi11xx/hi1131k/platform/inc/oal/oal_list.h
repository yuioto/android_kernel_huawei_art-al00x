...
#define OAL_LIST_GET_ENTRY(_list_ptr, _data_type, _data_member_list_name) \
    ((_data_type *)((oal_int8 *)(_list_ptr)-(oal_ulong)(&((_data_type *)0)->_data_member_list_name))) /*lint -e(413)*/
...
#define OAL_DLIST_SEARCH_FOR_EACH_SAFE(_dlist_pos, n, _dilst_head) \
    for ((_dlist_pos) = (_dilst_head)->pst_next, (n) = (_dlist_pos)->pst_next; \
        (_dlist_pos) != (_dilst_head); (_dlist_pos) = (n), (n) = (_dlist_pos)->pst_next)
...
#define OAL_DLIST_GET_ENTRY(_dlist_ptr, _data_type, _data_member_dlist_name) \
    /*lint -e(413)*/((_data_type *)((oal_int8 *)(_dlist_ptr)- \
    (oal_ulong)(uintptr_t)(&((_data_type *)0)->_data_member_dlist_name)))/*lint -e(413)*/
...
{
    oal_list_entry_stru *pst_node = OAL_PTR_NULL;
...
OAL_STATIC OAL_INLINE oal_dlist_head_stru* oal_dlist_delete_head(oal_dlist_head_stru *pst_head)
{
    ...
    OAL_BUG_ON(pst_node == OAL_PTR_NULL);
...
{
    oal_dlist_head_stru *pst_head2_first = OAL_PTR_NULL;
    oal_dlist_head_stru *pst_head2_tail = OAL_PTR_NULL;
    oal_dlist_head_stru *pst_head1_first = OAL_PTR_NULL;
