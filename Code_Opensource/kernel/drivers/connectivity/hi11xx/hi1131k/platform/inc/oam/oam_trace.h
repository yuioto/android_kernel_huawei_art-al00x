...
/* OAM PROFILING的控制结构 */
typedef struct {
    oal_long     i_profiling_tx_debuging_enable;
    oal_long     i_profiling_rx_debuging_enable;
    oal_long     i_profiling_alg_debuging_enable;
