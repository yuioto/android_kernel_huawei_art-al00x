...
/*****************************************************************************
  2 宏定义
*****************************************************************************/
/* oam_ext_if.h linux和liteos共代码 */
#if ((_HI113X_SW_VERSION == _HI113X_SW_DEBUG) || (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION))
...
#define OAM_INFO_LOG0(_uc_vap_id, _en_feature_id, fmt)    \
    OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, \
    _uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_INFO, fmt, 0, 0, 0, 0);
#define OAM_INFO_LOG1(_uc_vap_id, _en_feature_id, fmt, p1)    \
    OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, \
    _uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_INFO, fmt, (uint32_t)(p1), 0, 0, 0);
#define OAM_INFO_LOG2(_uc_vap_id, _en_feature_id, fmt, p1, p2)    \
    OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, \
    _uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_INFO, fmt, (uint32_t)(p1), (uint32_t)(p2), 0, 0);
#define OAM_INFO_LOG3(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3)    \
    OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, \
    _uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_INFO, fmt, (uint32_t)(p1), (uint32_t)(p2), (uint32_t)(p3), 0);
#define OAM_INFO_LOG4(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3, p4)    \
    OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, _uc_vap_id, \
    _en_feature_id, OAM_LOG_LEVEL_INFO, fmt, (uint32_t)(p1), (uint32_t)(p2), (uint32_t)(p3), (uint32_t)(p4));

#define OAM_WARNING_LOG0(_uc_vap_id, _en_feature_id, fmt) \
    OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, \
    _uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_WARNING, fmt, 0, 0, 0, 0);
#define OAM_WARNING_LOG1(_uc_vap_id, _en_feature_id, fmt, p1)  \
    OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, \
    _uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_WARNING, fmt, (uint32_t)(p1), 0, 0, 0);
#define OAM_WARNING_LOG2(_uc_vap_id, _en_feature_id, fmt, p1, p2)  \
    OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, \
    _uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_WARNING, fmt, (uint32_t)(p1), (uint32_t)(p2), 0, 0);
#define OAM_WARNING_LOG3(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3)  \
    OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, \
    _uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_WARNING, fmt, (uint32_t)(p1), (uint32_t)(p2), (uint32_t)(p3), 0);
#define OAM_WARNING_LOG4(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3, p4)  \
    OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, _uc_vap_id, \
    _en_feature_id, OAM_LOG_LEVEL_WARNING, fmt, (uint32_t)(p1), (uint32_t)(p2), (uint32_t)(p3), (uint32_t)(p4));
#define OAM_ERROR_LOG0(_uc_vap_id, _en_feature_id, fmt)  \
    do { \
        OAL_IO_PRINT_ERR(fmt); \
        OAL_IO_PRINT_ERR("\n"); \
        OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, \
        _uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_ERROR, fmt, 0, 0, 0, 0); \
    }while (0)
#define OAM_ERROR_LOG1(_uc_vap_id, _en_feature_id, fmt, p1) \
    do { \
        OAL_IO_PRINT_ERR(fmt, p1); \
        OAL_IO_PRINT_ERR("\n"); \
        OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, \
        _uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_ERROR, fmt, (uint32_t)(p1), 0, 0, 0); \
    }while (0)
#define OAM_ERROR_LOG2(_uc_vap_id, _en_feature_id, fmt, p1, p2) \
    do { \
        OAL_IO_PRINT_ERR(fmt, p1, p2); \
        OAL_IO_PRINT_ERR("\n"); \
        OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, \
        _uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_ERROR, fmt, (uint32_t)(p1), (uint32_t)(p2), 0, 0); \
    }while (0)
#define OAM_ERROR_LOG3(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3) \
    do { \
        OAL_IO_PRINT_ERR(fmt, p1, p2, p3); \
        OAL_IO_PRINT_ERR("\n"); \
        OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, \
        _uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_ERROR, fmt, (uint32_t)(p1), (uint32_t)(p2), (uint32_t)(p3), 0); \
    }while (0)
#define OAM_ERROR_LOG4(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3, p4) \
    do { \
        OAL_IO_PRINT_ERR(fmt, p1, p2, p3, p4); \
        OAL_IO_PRINT_ERR("\n"); \
        OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR, _uc_vap_id,\
        _en_feature_id, OAM_LOG_LEVEL_ERROR, fmt, (uint32_t)(p1), (uint32_t)(p2), (uint32_t)(p3), (uint32_t)(p4)); \
    }while (0)
...
#define OAM_ERROR_LOG3(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3) \
    do { \
        dprintf(fmt, p1, p2, p3); \
        dprintf("\n"); \
    }while (0)

#define OAM_ERROR_LOG4(_uc_vap_id, _en_feature_id, fmt, p1, p2, p3, p4) \
    do { \
        dprintf(fmt, p1, p2, p3, p4); \
        dprintf("\n"); \
    }while (0)
...
typedef enum {
    ...
    /* 上报sdt的日志数据包含OAM_DATA_TYPE_STRING 及1131liteos适配的开源
    代码打印wpa_printf和自研代码打印HISI_PRINT，
    其中适配的开源和自研打印有流控OAM_RATELIMIT_TYPE_WPA_PRINTF_AND_HISI_PRINT，
    OAM_DATA_TYPE_STRING与k3保持一致，没有流控 */
    OAM_DATA_TYPE_STRING_AND_WPA_PRINTF_AND_HISI_PRINT = 0x42,
...
typedef enum {
    ...
    OAM_RATELIMIT_TYPE_WPA_PRINTF_AND_HISI_PRINT,
...
typedef oal_int32   (* oam_sdt_report_data_func)(oal_netbuf_stru *pst_netbuf, oam_data_type_enum_uint8 en_type,
...
typedef struct {
    ...
    /* 单播帧开关，不同用户开关可以不同 */
    oam_80211_frame_ctx_stru   ast_80211_ucast_mgmt_ctx[OAM_OTA_FRAME_DIRECTION_TYPE_BUTT];
    /* 单播帧开关，不同用户开关可以不同 */
    oam_80211_frame_ctx_stru   ast_80211_ucast_data_ctx[OAM_OTA_FRAME_DIRECTION_TYPE_BUTT];
...
/* 用于保存LOG文件地址的字符串最大长度,路径最长为255字节，最后需要有一字节存放\0 */
...
extern oal_uint32 oam_log_set_feature_level(oal_uint8 uc_vap_id,
                                            oam_feature_enum_uint8   en_feature_id,
                                            oam_log_level_enum_uint8 en_log_level);
extern oal_uint32 oam_get_feature_id(const oal_uint8 *puc_feature_name,
...
extern oal_uint32  oam_log_console_printk(
    oal_uint16 us_file_no, oal_uint16 us_line_num, const oal_int8 *pc_func_name, const oal_int8 *pc_fmt, ...);
...
extern oal_uint32  oam_report_eth_frame(const unsigned char          *puc_user_mac_addr,
...
extern oal_uint32 oam_report_dscr(const oal_uint8  *puc_user_macaddr,
...
extern oal_uint32  oam_report_netbuf_cb(const oal_uint8  *puc_user_mac_addr,
                                        const oal_uint8  *puc_netbuf_cb,
                                        oam_ota_type_enum_uint8 en_ota_type);
extern oal_uint32  oam_report_mpdu_num(const oal_uint8  *puc_user_mac_addr,
                                       oam_report_mpdu_num_stru *pst_mpdu_num);
extern oal_uint32  oam_report_dft_params(const oal_uint8  *puc_user_mac_addr,
...
extern oal_switch_enum_uint8  oam_report_data_get_global_switch(
...
extern oal_void oam_profiling_tx_save_data(
    oal_void *pst_netbuf, oam_profiling_tx_func_enum_uint8 en_func_index);
...
extern oal_uint32  oam_stats_report_mempool_info_to_sdt(
    ...
    oal_uint16          us_subpool_total_cnt,
    oal_uint16          us_subpool_free_cnt);
extern oal_uint32  oam_stats_report_memblock_info_to_sdt(const oal_uint8 *puc_origin_data,
...
extern oal_void  oam_profiling_starttime_save_timestamp(
    oam_profiling_starttime_func_enum_uint8 en_func_idx);
extern oal_void  oam_profiling_starttime_show_offset(oal_void);
extern oal_void  oam_profiling_chswitch_save_timestamp(
    oam_profiling_chswitch_func_enum_uint8 en_func_idx);
...
extern oal_int32  oam_netlink_kernel_send(
    oal_uint8 *puc_data, oal_uint32 ul_data_len, oam_nl_cmd_enum_uint8 en_type);
    ...
    oam_log_level_enum_uint8            en_log_level)
{
    ...
    if (g_st_oam_mng_ctx.st_log_ctx.en_global_log_switch == OAL_SWITCH_OFF) {
        return OAL_SWITCH_OFF;
    } else if (g_st_oam_mng_ctx.st_log_ctx.st_vap_log_info.aen_vap_log_switch[uc_vap_id] == OAL_SWITCH_OFF) {
        return OAL_SWITCH_OFF;
    } else if (en_log_level > g_st_oam_mng_ctx.st_log_ctx.st_vap_log_info.aen_vap_log_level[uc_vap_id]) {
        return OAL_SWITCH_OFF;
    } else if (en_log_level > \
        g_st_oam_mng_ctx.st_log_ctx.st_vap_log_info.aen_feature_log_level[uc_vap_id][en_feature_id]) {
        return OAL_SWITCH_OFF;
    }
