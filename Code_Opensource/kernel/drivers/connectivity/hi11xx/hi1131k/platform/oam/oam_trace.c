...
{
    /* 开关判断 */
    if (g_oam_profiling_statistic_rx.ast_rx_func_stand_time[g_oam_profiling_statistic_rx.uc_skb_id_idx][en_func_index]
        == 0) {
        g_oam_profiling_statistic_rx.ast_rx_func_stand_time[g_oam_profiling_statistic_rx.uc_skb_id_idx][en_func_index]
...
oal_uint32  oam_profiling_rx_show_offset(oal_void)
{
    ...
    for (ul_packet_idx = 0; ul_packet_idx < 1 /* OAM_PROFILING_RX_PACKET_MAX_COUNT */ ; ul_packet_idx++) {
        ...
        for (ul_func_idx = OAM_PROFILING_FUNC_RX_COMP_IRQ_START; ul_func_idx <= OAM_PROFILING_FUNC_RX_DMAC_END; \
             ul_func_idx++) {
            OAL_IO_PRINT("\nNo%3d ", ul_func_idx);
            ...
            if (ul_func_idx != OAM_PROFILING_FUNC_RX_COMP_IRQ_START) {
                ul_time_offset = g_oam_profiling_statistic_rx.ast_rx_func_stand_time[ul_packet_idx][ul_func_idx - 1] - 
                                 g_oam_profiling_statistic_rx.ast_rx_func_stand_time[ul_packet_idx][ul_func_idx];
                OAL_IO_PRINT("%10u ", ul_time_offset);
            }
        }

        ul_time_offset =
            g_oam_profiling_statistic_rx.ast_rx_func_stand_time[ul_packet_idx][OAM_PROFILING_FUNC_RX_COMP_IRQ_START] -
            g_oam_profiling_statistic_rx.ast_rx_func_stand_time[ul_packet_idx][OAM_PROFILING_FUNC_RX_DMAC_END];
    ...
    oam_profiling_tx_func_enum_uint8    en_func_index)
{
    ...
    if (g_oam_profiling_statistic_tx.ast_tx_func_stand_time[g_oam_profiling_statistic_tx.uc_skb_id_idx][en_func_index]\
            == 0) {
        g_oam_profiling_statistic_tx.ast_tx_func_stand_time[g_oam_profiling_statistic_tx.uc_skb_id_idx][en_func_index]\
            = oal_5115timer_get_10ns();
    }
    ...
    for (ul_packet_idx = 0; ul_packet_idx < 1 /* OAM_PROFILING_TX_PACKET_MAX_COUNT */ ; ul_packet_idx++) {
        ...
        for (ul_func_idx = OAM_PROFILING_FUNC_CONFIG_XMIT_START; ul_func_idx <= OAM_PROFILING_FUNC_CONFIG_XMIT_END; ul_func_idx++) {
            ...
            if (ul_func_idx != OAM_PROFILING_FUNC_CONFIG_XMIT_START) {
                ul_time_offset = g_oam_profiling_statistic_tx.ast_tx_func_stand_time[ul_packet_idx][ul_func_idx - 1] -
                                 g_oam_profiling_statistic_tx.ast_tx_func_stand_time[ul_packet_idx][ul_func_idx];
                OAL_IO_PRINT("%10u ", ul_time_offset);
            }
        }
...
oal_uint32  oam_profiling_statistic_init(oal_void)
{
    ...
    memset_s(&g_oam_profiling_statistic_chswitch, OAL_SIZEOF(g_oam_profiling_statistic_chswitch),
             0, OAL_SIZEOF(g_oam_profiling_statistic_chswitch));
