...
typedef struct {
    ...
    oal_uint8 auc_resv[3]; // 预留buff3字节，同时用于对齐
...
typedef struct {
    ...
    oal_void (*p_event_handler_func)(oal_ulong); /* tasklet处理程序 */
} frw_task_stru;
#endif
...
extern oal_void frw_task_event_handler_register(oal_void (*p_func)(oal_ulong));
