...
OAL_STATIC oal_uint32 frw_ipc_send_inter_msg(oal_uint8 uc_msg_type, const oal_uint8 *puc_data, oal_uint8 us_len);
...
OAL_STATIC oal_void frw_ipc_recv_switch(frw_ipc_msg_mem_stru *pst_ipc_mem_msg, \
    frw_ipc_msg_header_stru *pst_header, frw_ipc_core_type_enum_uint8 en_type)
{
...
OAL_STATIC oal_void frw_ipc_recv(frw_ipc_msg_mem_stru *pst_ipc_mem_msg)
{
    frw_ipc_msg_header_stru *pst_header = OAL_PTR_NULL; /* 消息头部结构体 */
    ...
    if (OAL_UNLIKELY(pst_header == OAL_PTR_NULL || pst_header->uc_target_cpuid > FRW_IPC_CORE_NUM_BUTT ||
...
#ifdef _PRE_DEBUG_MODE
    /* 接收日志 */
    frw_ipc_log_recv(&g_st_ipc_node[en_type].st_log, pst_header->us_seq_number, pst_header->uc_target_cpuid,
        pst_header->uc_msg_type);
#endif
    frw_ipc_recv_switch(pst_ipc_mem_msg, pst_header, en_type);
...
OAL_STATIC oal_uint32 frw_ipc_send(frw_ipc_msg_mem_stru *pst_ipc_mem_msg)
{
    oal_uint32 ul_ret;
    frw_ipc_msg_header_stru *pst_header = OAL_PTR_NULL;   /* 消息头部结构体 */
    frw_ipc_msg_queue_stru *pst_msg_queue = OAL_PTR_NULL; /* 消息队列 */
    frw_ipc_core_type_enum_uint8 en_type;                 /* CPU类型: 主核或从核 */
    ...
    /* 检查当前IPC模块状态 */
    if (g_st_ipc_node[en_type].en_states != FRW_IPC_CORE_STATE_CONNECTED) {
        OAM_WARNING_LOG2(0, OAM_SF_FRW,
            "{frw_ipc_send::FRW_IPC_CORE_STATE_CONNECTED != g_st_ipc_node[en_type].en_states. en_type:%d, "
    ...
    /* 发送核间消息 */
    ul_ret = frw_ipc_msg_queue_send(pst_msg_queue, pst_ipc_mem_msg, g_st_ipc_node[en_type].en_tx_int_ctl,
...
#endif
        OAM_WARNING_LOG1(0, OAM_SF_FRW, "{frw_ipc_send:msg_queue_send reterr code: %d}", OAL_ERR_CODE_IPC_QUEUE_FULL);
        return ul_ret;
    }

    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_FRW, "{frw_ipc_send:msg_queue_send reterr code:%d}", ul_ret);
        return ul_ret;
    }
...
#ifdef _PRE_DEBUG_MODE
    /* 发送日志 */
    frw_ipc_log_send(&g_st_ipc_node[en_type].st_log, pst_header->us_seq_number, pst_header->uc_target_cpuid,
        pst_header->uc_msg_type);
#endif
...
OAL_STATIC oal_uint32 frw_ipc_init_master(frw_ipc_node_stru *pst_ipc_node)
{
    ...
    /* 主核完成消息队列初始化 */
    /* 发送队列初始化 */
    ul_ret = frw_ipc_msg_queue_init(&g_st_queue_master_to_slave, FRW_IPC_MASTER_TO_SLAVE_QUEUE_MAX_NUM);
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_FRW,
            "{frw_ipc_init_master: frw_ipc_msg_queue_init g_st_queue_master_to_slave return err code:%d}", ul_ret);
        return ul_ret;
    }

    /* 接收队列初始化 */
    ul_ret = frw_ipc_msg_queue_init(&g_st_queue_slave_to_master, FRW_IPC_SLAVE_TO_MASTER_QUEUE_MAX_NUM);
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_FRW,
            "{frw_ipc_init_master:: frw_ipc_msg_queue_init g_st_queue_slave_to_master return err code:%d}", ul_ret);
        return ul_ret;
    }
    ...
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_FRW, "{frw_ipc_init_master: frw_ipc_msg_queue_register_callback return err code:%d}",
            ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 frw_ipc_init_slave(frw_ipc_node_stru *pst_ipc_node)
{
    ...
    ul_ret = frw_ipc_msg_queue_register_callback(&pst_ipc_node->st_ipc_msg_callback);
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_FRW, "{frw_ipc_init_slave:: frw_ipc_msg_queue_register_callback return err code:%d}",
            ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 frw_ipc_exit(oal_void)
{
    ...
    if (en_type == FRW_IPC_CORE_ID_MASTER) { /* 主核 */
        ...
        if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
            OAM_WARNING_LOG1(0, OAM_SF_FRW,
                "{frw_ipc_exit: frw_ipc_msg_queue_destroy g_st_queue_master_to_slave return err code:%d}", ul_ret);
            return ul_ret;
        }
        ...
        if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
            OAM_WARNING_LOG1(0, OAM_SF_FRW,
                "frw_ipc_exit:: frw_ipc_msg_queue_destroy g_st_queue_slave_to_master return err code:%d", ul_ret);
            return ul_ret;
        }
    }
...
OAL_STATIC oal_uint32 frw_ipc_send_connect_request(oal_void)
{
    ...
    ul_ret = frw_ipc_send_inter_msg(FRW_IPC_MSG_TYPE_CONNECT_REQUEST, OAL_PTR_NULL, 0);
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
...
OAL_STATIC oal_uint32 frw_ipc_send_inter_msg(oal_uint8 uc_msg_type, const oal_uint8 *puc_data, oal_uint8 us_len)
{
    ...
    frw_ipc_inter_msg_stru *pst_ipc_msg = OAL_PTR_NULL; /* 消息结构体 */
    ...
    /* 申请核间内部消息内存 */
    ul_length = OAL_SIZEOF(frw_ipc_inter_msg_stru) - 4 + us_len; // 偏移4字节
    ...
    if (OAL_UNLIKELY(pst_ipc_msg == OAL_PTR_NULL)) {
    ...
    /* 填充数据 */
    if (us_len > 0) {
        ul_ret = (oal_uint32)memcpy_s((oal_void *)pst_ipc_msg->auc_data, pst_ipc_msg->ul_length, (oal_void *)puc_data,
            us_len);
        if (ul_ret != EOK) {
            OAM_ERROR_LOG1(0, OAM_SF_FRW, "{frw_ipc_send_inter_msg: memcpy_s fail[%lu]!}", ul_ret);
            FRW_EVENT_FREE(pst_msg_mem_stru);
            return ul_ret;
        }
    }
    ...
    /* 发送内部消息 */
    ul_ret = frw_ipc_msg_queue_send(pst_msg_queue, pst_msg_mem_stru, g_st_ipc_node[en_type].en_tx_int_ctl,
        g_st_ipc_node[en_type].en_target_cpuid);
    if (OAL_UNLIKELY(ul_ret != OAL_SUCC)) {
...
#ifdef _PRE_DEBUG_MODE
    /* 发送日志 */
    frw_ipc_log_send(&g_st_ipc_node[en_type].st_log, g_st_ipc_node[en_type].us_seq_num_tx_expect,
        g_st_ipc_node[en_type].en_target_cpuid, uc_msg_type);
#endif
    ...
    frw_event_deploy_enum_uint8 *en_deploy_result)
{
    ...
    if (OAL_UNLIKELY(pst_ipc_mem_msg == OAL_PTR_NULL) || (en_deploy_result == OAL_PTR_NULL)) {
        OAM_ERROR_LOG2(0, OAM_SF_FRW,
            "{frw_event_deploy_pipeline: pst_ipc_mem_msg/en_deploy_result null ptr err:%p, %p}",
...
oal_uint32  frw_event_deploy_owner(frw_ipc_msg_mem_stru *pst_ipc_mem_msg,
                                   frw_event_deploy_enum_uint8 *en_deploy_result)
{
    if ((pst_ipc_mem_msg == OAL_PTR_NULL) || (en_deploy_result == OAL_PTR_NULL)) {
        FRW_ERR_LOG2(0, "frw_event_deploy_owner: pst_ipc_mem_msg/en_deploy_result null ptr err:",
                     pst_ipc_mem_msg, en_deploy_result);
        return OAL_ERR_CODE_PTR_NULL;
    }
