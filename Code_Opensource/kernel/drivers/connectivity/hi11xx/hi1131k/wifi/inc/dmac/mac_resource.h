...
#else
#define MAC_RES_USER_SIZE       1832 //ut dmac_user_stru结构体大小大于1520
#endif
#else
...
#else
#define MAC_RES_VAP_SIZE        3104 /*VAP实际结构体大小加128字节*/
...
#else
#define MAC_RES_USER_SIZE       3748 /*USER实际结构体大小加128字节*/
#endif /* _PRE_LITEOS_WLAN_FEATURE_MEM_REDUCE */
...
{
    return &(g_st_mac_res.st_dev_res.ast_dev_info[0]);
}
