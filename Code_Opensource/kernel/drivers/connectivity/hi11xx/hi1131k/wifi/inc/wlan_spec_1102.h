...
/* 整个BOARD支持的最大的VAP数目 */
#define WLAN_VAP_SUPPOTR_MAX_NUM_SPEC       (WLAN_CHIP_MAX_NUM_PER_BOARD * WLAN_DEVICE_MAX_NUM_PER_CHIP * \
    WLAN_VAP_MAX_NUM_PER_DEVICE_SPEC)   /* 5个或者18个 */

/* 整个BOARD支持的最大业务VAP的数目 */
#define WLAN_SERVICE_VAP_SUPPOTR_MAX_NUM_SPEC     (WLAN_CHIP_MAX_NUM_PER_BOARD * WLAN_DEVICE_MAX_NUM_PER_CHIP * \
    (WLAN_VAP_MAX_NUM_PER_DEVICE_SPEC - 1))
...
/* KeepAlive保活操作在多久没有数据交互后开始启动 */
#define WLAN_USER_KEEPALIVE_WAIT_TIME           (WLAN_USER_AGING_TIME - (WLAN_USER_AGING_TIME >> 2))
#endif

#define WLAN_USER_KEEPALIVE_TRIGGER_TIME        (15 * 1000)       /* keepalive定时器触发周期 单位ms */
...
/* 高优先级接收描述符队列中描述符最大个数:取决于并发用户数(32) */
...
/* mate7 pps门限 */
#define MATE7_PPS_VALUE_0              0
#define MATE7_PPS_VALUE_1              1000
#define MATE7_PPS_VALUE_2              5000
#define MATE7_PPS_VALUE_3              8000
/* mate7 CPU主频下限 */
#define MATE7_CPU_MIN_FREQ_VALUE_0              403200
#define MATE7_CPU_MIN_FREQ_VALUE_1              604800
#define MATE7_CPU_MIN_FREQ_VALUE_2              806400
#define MATE7_CPU_MIN_FREQ_VALUE_3              1305600
/* mate7 DDR主频下限 */
#define MATE7_DDR_MIN_FREQ_VALUE_0              0
#define MATE7_DDR_MIN_FREQ_VALUE_1              360000000
#define MATE7_DDR_MIN_FREQ_VALUE_2              400000000
#define MATE7_DDR_MIN_FREQ_VALUE_3              800000000


/* AUSTIN门限       CPU主频下限     DDR主频下限 */
/* AUSTIN pps门限 */
#define AUSTIN_PPS_VALUE_0              0
#define AUSTIN_PPS_VALUE_1              1000
#define AUSTIN_PPS_VALUE_2              7000
#define AUSTIN_PPS_VALUE_3              10000
/* AUSTIN CPU主频下限 */
#define AUSTIN_CPU_MIN_FREQ_VALUE_0              480000
#define AUSTIN_CPU_MIN_FREQ_VALUE_1              807000
#define AUSTIN_CPU_MIN_FREQ_VALUE_2              1306000
#define AUSTIN_CPU_MIN_FREQ_VALUE_3              1805000
/* AUSTIN DDR主频下限 */
#define AUSTIN_DDR_MIN_FREQ_VALUE_0              0
#define AUSTIN_DDR_MIN_FREQ_VALUE_1              360000000
#define AUSTIN_DDR_MIN_FREQ_VALUE_2              360000000
#define AUSTIN_DDR_MIN_FREQ_VALUE_3              1333000000
...
// 2.12 COEX FEATURE
#define BTCOEX_RSSI_THRESHOLD               (-70)
#define BTCOEX_RATE_THRESHOLD_MIN_20M       32000
#define BTCOEX_RATE_THRESHOLD_MAX_20M       62000
#define BTCOEX_RATE_THRESHOLD_MIN_40M       50000
#define BTCOEX_RATE_THRESHOLD_MAX_40M       132000
...
#define BTCOEX_RX_COUNT_LIMIT               64
