...
extern oal_void hmac_autoblacklist_filter(mac_vap_stru *pst_mac_vap, const oal_uint8 *puc_mac_addr);
extern oal_uint32 hmac_blacklist_set_mode(mac_vap_stru *pst_mac_vap, oal_uint8 uc_mode);
extern oal_uint32 hmac_blacklist_add(mac_vap_stru *pst_mac_vap, const oal_uint8 *puc_mac_addr,
    oal_uint32 ul_aging_time);
extern oal_uint32 hmac_blacklist_add_only(mac_vap_stru *pst_mac_vap, const oal_uint8 *puc_mac_addr,
    oal_uint32 ul_aging_time);
extern oal_uint32 hmac_blacklist_del(mac_vap_stru *pst_mac_vap, const oal_uint8 *puc_mac_addr);

extern oal_uint32 hmac_blacklist_update(mac_vap_stru *pst_mac_vap, hmac_blacklist_cfg_stru *pst_blacklist_cfg);
extern oal_bool_enum_uint8 hmac_blacklist_filter(mac_vap_stru *pst_mac_vap, const oal_uint8 *puc_mac_addr);
extern oal_void hmac_show_blacklist_info(mac_vap_stru *pst_mac_vap);
extern oal_uint32 hmac_backlist_get_drop(mac_vap_stru *pst_mac_vap, const oal_uint8 *puc_mac_addr);
