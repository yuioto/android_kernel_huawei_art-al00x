...
extern mac_bss_dscr_stru *hmac_scan_find_scanned_bss_dscr_by_index(oal_uint8 uc_device_id, oal_uint32 ul_bss_index);
extern hmac_scanned_bss_info *hmac_scan_find_scanned_bss_by_bssid(hmac_bss_mgmt_stru *pst_bss_mgmt,
                                                                  const uint8_t      *puc_bssid);
extern void *hmac_scan_get_scanned_bss_by_bssid(mac_vap_stru *mac_vap, uint8_t *mac_addr);
...
#endif
extern oal_uint32 hmac_bgscan_enable(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, const oal_uint8 *puc_param);
