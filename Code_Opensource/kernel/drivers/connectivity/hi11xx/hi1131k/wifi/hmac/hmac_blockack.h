...
#define HMAC_Non_Proxysta_BA_LUT_IDX_BMAP_LEN   ((HAL_MAX_BA_LUT_SIZE + 7) >> 4) /* 非Proxy STA LUT表需要两个字节0~15 */
...
#define HMAC_TX_BUF_BITMAP_LOG2_WORD_SIZE 5 /* 注释原因为什么是log2(32) == 5 */
    ...
    mac_ieee80211_frame_stru *pst_frame_hdr)
{
    ...
    while (hmac_ba_seqno_lt(pst_ba_rx_hdl->us_baw_head, DMAC_BA_SEQNO_SUB(pst_ba_rx_hdl->us_baw_start,
        (HMAC_BA_BMP_SIZE - 1)))) {
...
OAL_STATIC OAL_INLINE hmac_rx_buf_stru *hmac_remove_frame_from_reorder_q(hmac_ba_rx_stru *pst_ba_rx_hdl,
...
{
    return oal_get_lut_index(puc_ba_lut_index_table, HMAC_Non_Proxysta_BA_LUT_IDX_BMAP_LEN,
...
extern oal_uint8  hmac_mgmt_check_set_rx_ba_ok(hmac_vap_stru *pst_hmac_vap, hmac_ba_rx_stru *pst_ba_rx_info,
    mac_device_stru *pst_device);

extern oal_void hmac_reorder_ba_rx_buffer_bar(hmac_ba_rx_stru *pst_rx_ba, oal_uint16 us_start_seq_num,
    mac_vap_stru *pst_vap);
extern oal_uint32  hmac_ba_reset_rx_handle(mac_device_stru *pst_mac_device, hmac_ba_rx_stru **ppst_rx_ba,
    oal_uint8 uc_tid, oal_bool_enum_uint8 en_is_aging);
