...
/*****************************************************************************
  10 函数声明
*****************************************************************************/
extern oal_uint16  hmac_mgmt_encap_deauth(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_data, const oal_uint8 *puc_da,
                                          oal_uint16 us_err_code);
extern oal_uint16  hmac_mgmt_encap_disassoc(mac_vap_stru  *pst_mac_vap,
                                            oal_uint8     *puc_data,
                                            const uint8_t *puc_da,
                                            oal_uint16    us_err_code);
extern oal_uint16  hmac_encap_sa_query_req(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_data, const oal_uint8 *puc_da,
...
extern oal_uint16 hmac_encap_notify_chan_width(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_data, const oal_uint8 *puc_da);
