...
#ifdef COMPILE_BY_ANDROID
#include <bits/timespec.h>
#include <libgen.h>
#include <pthread.h>
#include <linux/swab.h>
#include <android/log.h>
#define LOG_TAG "samba"
#define LOGD(...) __android_log_print(ANDROID_LOG_DEBUG, LOG_TAG, __VA_ARGS__)
#endif

#define NON_ROOT_START 1
#define NOT_HAVE_POPT 1
#define NOT_SUPPORT_PRINTER 1
// samba log is forbidened since P, so no need LOG_SIZE_CONTROL
#ifndef COMPILE_BY_ANDROID
#define ADD_LOG_SIZE_CONTROL 1
#endif
#define ADD_ANDROID_SUPPORT	1
#define ADD_UNIX_SOCKET 1
#define ADD_LOGIN_CONTROL 1
#define MBB_CAN_NOT_USE 1		

#ifdef HUAWEI_CUSTOM_PERFORMANCE
#define ADD_BUGFIX1 1
#define ADD_BUGFIX2 1
//#define ADD_BUGFIX 1			/* rpc_server\srv_spoolss_nt.c 5808*/
#define CUT_SECURITY_DOMAIN 1
#define ADD_SECURITY_PATCH 1
#define ADD_SECURITY_PATCH1 1
#define CUT_SMBPASSWD 1
#define MBB_CUT_SMBPASSWD 1
//#define NOT_CUT 1
#define CUT_OTHER_CODES 1
#define ADD_OTHER_CHANGE 1
#define ADD_OTHER_CHANGE1 1
#define CHECK_OLD_LOGIN 1
#define NO_APPLEDOUBLE 1

#else
#define NOT_CUT 1
#endif

#define LAN_DEVICE			"wlan0"
...
typedef enum {
	FOP_DEFAULT = 0x0000,
	FOP_CREATE_FILE = 0x0001,
	FOP_CREATE_DIR = 0x0002,
	FOP_RENAME = 0x0003,
	FOP_DELETE_FILE = 0x0004,
	FOP_DELETE_DIR = 0x0005,
} fop_types;
#endif
