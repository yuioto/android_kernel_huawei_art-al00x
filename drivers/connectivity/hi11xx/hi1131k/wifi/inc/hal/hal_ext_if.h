...
OAL_STATIC OAL_INLINE oal_void hal_tx_ctrl_dscr_link(hal_to_dmac_device_stru *pst_hal_device,
                                                     hal_tx_dscr_stru *pst_tx_dscr_prev,
...
{
    HAL_PUBLIC_HOOK_FUNC5(_tx_ucast_data_set_dscr, pst_hal_device, pst_tx_dscr,
        pst_txop_feature, pst_txop_alg, pst_ppdu_feature);
}
...
OAL_STATIC OAL_INLINE oal_void hal_tx_non_ucast_data_set_dscr(hal_to_dmac_device_stru *pst_hal_device,
                                                              ...
                                                              hal_tx_ppdu_feature_stru *pst_ppdu_feature)
{
    HAL_PUBLIC_HOOK_FUNC5(_tx_non_ucast_data_set_dscr, pst_hal_device, pst_tx_dscr,
        pst_txop_feature, pst_txop_alg, pst_ppdu_feature);
}
...
OAL_STATIC OAL_INLINE oal_void hal_freq_adjust(hal_to_dmac_device_stru *pst_hal_device,
...
OAL_STATIC OAL_INLINE oal_void hal_machw_seq_num_index_update_per_tid(hal_to_dmac_device_stru *pst_hal_device,
                                                                      oal_uint8 uc_lut_index,
...
#if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1151)
OAL_STATIC OAL_INLINE oal_void hal_get_irq_stat(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint8 *puc_param,
                                                oal_uint32 ul_len,
                                                hal_irq_stat_enum_uint8 en_type)
{
...
OAL_STATIC OAL_INLINE oal_void hal_dpd_cali_func(oal_uint8 en_functype,
                                                 oal_uint32 *pstatus,
                                                 oal_uint32 *pdpd_cal_data_read,
                                                 oal_uint32 *pdpd_cal_data_write)
{
...
OAL_STATIC OAL_INLINE oal_void hal_dpd_cali_func_1131(oal_uint8 en_functype,
                                                      oal_uint32 *pstatus,
                                                      oal_uint32 *pdpd_cal_data_read,
                                                      oal_uint32* pdpd_cal_data_write,
                                                      oal_uint8 uc_ch_idx,
...
{
#if ((_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1131C_DEV) || (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1131C_HOST))
    HAL_PUBLIC_HOOK_FUNC6(_dpd_cali_func_1131, en_functype, pstatus, pdpd_cal_data_read,
        pdpd_cal_data_write, uc_ch_idx, en_bandwidth);
#endif
}
#endif
...
OAL_STATIC OAL_INLINE oal_void hal_set_proxysta_vap_addr(hal_to_dmac_device_stru *pst_hal_device,
                                                         oal_uint8 vap_id,
...
OAL_STATIC OAL_INLINE oal_void hal_reg_info(hal_to_dmac_device_stru *pst_hal_device,
                                            oal_uint32 ul_addr,
                                            oal_uint32 *pul_val)
{
...
OAL_STATIC OAL_INLINE oal_void hal_reg_info16(hal_to_dmac_device_stru *pst_hal_device,
                                              oal_uint32 ul_addr,
                                              oal_uint16 *pus_val)
{
#if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1131C_DEV)
...
OAL_STATIC OAL_INLINE oal_void hal_get_rx_err_count(hal_to_dmac_device_stru *pst_hal_device,
                                                    ...
                                                    oal_uint32 *pul_cnt6)
{
    HAL_PUBLIC_HOOK_FUNC7(_get_rx_err_count, pst_hal_device, pul_cnt1, pul_cnt2,
...
OAL_STATIC OAL_INLINE oal_void hal_enable_sig(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_enable)
{
...
OAL_STATIC OAL_INLINE oal_void hal_set_tpc_init_rate_dac_lpf_table(oal_uint8 *pauc_rate_pow_table_2G,
...
OAL_STATIC OAL_INLINE oal_void hal_get_bcn_rate(hal_to_dmac_device_stru *pst_hal_device,
                                                oal_uint8 uc_vap_id,
...
OAL_STATIC OAL_INLINE oal_void hal_set_bcn_phy_tx_mode(hal_to_dmac_device_stru *pst_hal_device,
...
OAL_STATIC  OAL_INLINE oal_void hal_set_upc_data(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_uint8 uc_band,
                                                 oal_uint8 uc_subband_idx)
{
...
OAL_STATIC OAL_INLINE oal_void hal_set_cca_opt_stat(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_bool_enum_uint8 debug_val)
{
...
{
    HAL_PUBLIC_HOOK_FUNC4(_set_psm_dtim_period, pst_hal_vap, uc_dtim_period,
...
OAL_STATIC OAL_INLINE oal_void hal_set_txop_ps_partial_aid(hal_to_dmac_device_stru *pst_hal_device,
...
OAL_STATIC OAL_INLINE oal_void hal_set_tx_dscr_field(hal_to_dmac_device_stru *pst_hal_device,
                                                     oal_uint32 ul_data,
...
OAL_STATIC OAL_INLINE oal_void hal_rf_set_freq_skew(hal_to_dmac_device_stru *pst_hal_device,
                                                    oal_uint16 us_idx,
                                                    oal_uint16 us_chn,
                                                    oal_int16 as_corr_data[])
{
...
OAL_STATIC OAL_INLINE oal_void hal_rf_adjust_ppm(hal_to_dmac_device_stru *pst_hal_device,
                                                 oal_int8 c_ppm,
                                                 wlan_channel_bandwidth_enum_uint8 en_bandwidth,
                                                 oal_uint8 uc_clock)
{
...
OAL_STATIC OAL_INLINE oal_void hal_vap_tsf_get_32bit(hal_to_dmac_vap_stru *pst_hal_vap,
...
OAL_STATIC OAL_INLINE oal_void hal_set_adc_sample_rate_80m(hal_to_dmac_device_stru *pst_hal_device)
{
    HAL_PUBLIC_HOOK_FUNC1(_set_adc_sample_rate_80m, pst_hal_device);
}
...
OAL_STATIC OAL_INLINE hal_cipher_protocol_type_enum_uint8 hal_cipher_suite_to_ctype(
...
OAL_STATIC OAL_INLINE wlan_ciper_protocol_type_enum_uint8 hal_ctype_to_cipher_suite(
...
OAL_STATIC OAL_INLINE void hal_get_btcoex_abort_qos_null_seq_num(uint32_t *qosnull_seq_num)
{
    HAL_PUBLIC_HOOK_FUNC1(_get_btcoex_abort_qos_null_seq_num, qosnull_seq_num);
}
#endif
OAL_STATIC OAL_INLINE void hal_get_btcoex_pa_status(uint32_t *pa_status)
{
    HAL_PUBLIC_HOOK_FUNC1(_get_btcoex_pa_status, pa_status);
}
#ifdef _PRE_WLAN_FEATURE_BTCOEX
OAL_STATIC OAL_INLINE void hal_set_btcoex_abort_null_buff_addr(uint32_t abort_null_buff_addr)
{
    HAL_PUBLIC_HOOK_FUNC1(_set_btcoex_abort_null_buff_addr, abort_null_buff_addr);
}
OAL_STATIC OAL_INLINE void hal_set_btcoex_abort_qos_null_seq_num(uint32_t qosnull_seq_num)
{
    HAL_PUBLIC_HOOK_FUNC1(_set_btcoex_abort_qos_null_seq_num, qosnull_seq_num);
}
#endif
OAL_STATIC OAL_INLINE void hal_set_btcoex_hw_rx_priority_dis(uint8_t hw_rx_prio_dis)
{
    HAL_PUBLIC_HOOK_FUNC1(_set_btcoex_hw_rx_priority_dis, hw_rx_prio_dis);
}
OAL_STATIC OAL_INLINE void hal_set_btcoex_hw_priority_en(uint8_t hw_prio_en)
{
    HAL_PUBLIC_HOOK_FUNC1(_set_btcoex_hw_priority_en, hw_prio_en);
}
OAL_STATIC OAL_INLINE void hal_btcoex_get_rf_control(uint16_t occupied_period,
    uint32_t *wlbt_mode_sel, uint16_t wait_cnt)
{
    HAL_PUBLIC_HOOK_FUNC3(_btcoex_get_rf_control, occupied_period, wlbt_mode_sel, wait_cnt);
}
#ifdef _PRE_WLAN_FEATURE_BTCOEX
OAL_STATIC OAL_INLINE void hal_set_btcoex_sw_all_abort_ctrl(uint8_t sw_abort_ctrl)
{
    HAL_PUBLIC_HOOK_FUNC1(_set_btcoex_sw_all_abort_ctrl, sw_abort_ctrl);
}
#endif
OAL_STATIC OAL_INLINE void hal_set_btcoex_sw_priority_flag(uint8_t sw_prio_flag)
{
    HAL_PUBLIC_HOOK_FUNC1(_set_btcoex_sw_priority_flag, sw_prio_flag);
}
OAL_STATIC OAL_INLINE void hal_btcoex_init(void *arg)
{
    HAL_PUBLIC_HOOK_FUNC1(_btcoex_init, arg);
}
OAL_STATIC OAL_INLINE void hal_get_btcoex_statistic(oal_bool_enum_uint8 enable_abort_stat)
{
    HAL_PUBLIC_HOOK_FUNC1(_get_btcoex_statistic, enable_abort_stat);
}
OAL_STATIC OAL_INLINE void hal_mpw_soc_write_reg(uint32_t qury_reg_addr_tmp, uint16_t qury_reg_value_temp)
{
    HAL_PUBLIC_HOOK_FUNC2(_mpw_soc_write_reg, qury_reg_addr_tmp, qury_reg_value_temp);
}
OAL_STATIC OAL_INLINE void hal_btcoex_update_ap_beacon_count(uint32_t *beacon_count)
{
    HAL_PUBLIC_HOOK_FUNC1(_btcoex_update_ap_beacon_count, beacon_count);
}
#ifdef _PRE_WLAN_FEATURE_LTECOEX
OAL_STATIC OAL_INLINE void hal_ltecoex_req_mask_ctrl(uint16_t lte_req_mask)
{
...
OAL_STATIC OAL_INLINE oal_void hal_tx_get_dscr_iv_word(hal_tx_dscr_stru *pst_dscr,
                                                       oal_uint32 *pul_iv_ms_word,
                                                       oal_uint32 *pul_iv_ls_word,
                                                       oal_uint8 uc_chiper_type,
                                                       oal_uint8 uc_chiper_key_id)
{
    HAL_PUBLIC_HOOK_FUNC5(_tx_get_dscr_iv_word, pst_dscr, pul_iv_ms_word, pul_iv_ls_word,
