...
/* 配置命令 ID 第一段  MIB 类配置 第二段  非MIB类配置 */
typedef enum {
    // 第一段 MIB 类配置
...
#endif
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
    WLAN_CFGID_CHECK_LTE_GPIO      = 127, /* WLAN_CFGID_SET_REKEY */
#endif
    /* wep */
    ...
    WLAN_CFGID_BTCOEX_AUTO_FREQ_ENABLE  = 544,
#endif
#endif

    WLAN_CFGID_PSM_GET_TXRX_INFO = 545,
    WLAN_CFGID_PSM_GET_BEACON_INFO = 546,
    ...
    WLAN_CFGID_CFG80211_EXTERNAL_AUTH   = 560,   /* 触发SAE认证 */
    ...
    WLAN_CFIGD_MCS_SET_CHECK_ENABLE     = 617,      /* 是否检查mcs 速率集 */
#ifndef CONFIG_HAS_EARLYSUSPEND
    WLAN_CFGID_SET_SUSPEND_MODE         = 618,      /* 设置亮暗屏状态 */
#endif
#ifdef _PRE_WLAN_FEATURE_IP_FILTER
    WLAN_CFGID_IP_FILTER                = 619,      /* 配置IP端口过滤的命令 */
    WLAN_CFGID_ASSIGNED_FILTER          = 620,
#endif //_PRE_WLAN_FEATURE_IP_FILTER
    WLAN_CFGID_HIGH_POWER_SWITCH        = 621,      /* 设置高功耗开关 */
    WLAN_CFGID_SET_AUTH_RSP_TIME        = 622,
    WLAN_CFGID_FORBIT_OPEN_AUTH         = 623,
#ifdef _PRE_WLAN_FEATURE_1131K_BTCOEX
    WLAN_CFGID_BTCOEX_CHANNEL_SWITCH    = 624,
#endif
    WLAN_CFGID_RX_FILTER_FRAG           = 625,
...
typedef struct {
    ...
    oal_uint32          ul_dot11AuthenticationResponseTimeOut;
    ...
    oal_bool_enum_uint8 en_dot11MultiDomainCapabilityActivated;
    oal_bool_enum_uint8 en_dot11SpectrumManagementImplemented;
    oal_bool_enum_uint8 en_dot11SpectrumManagementRequired;
    ...
    oal_uint32          ul_dot11AssociationSAQueryMaximumTimeout;
    oal_uint32          ul_dot11AssociationSAQueryRetryTimeout;
    oal_bool_enum_uint8 en_dot11HighThroughputOptionImplemented;
    oal_bool_enum_uint8 en_dot11VHTOptionImplemented;
...
typedef struct {
    ...
    oal_bool_enum_uint8 en_dot11AuthenticationAlgorithmsActivated;
...
typedef struct {
    ...
    oal_uint32 ul_dot11RSNAConfigNumberOfPTKSAReplayCountersImplemented;
    ...
    oal_uint32 ul_dot11RSNAConfigNumberOfGTKSAReplayCountersImplemented;
...
typedef struct {
    ...
    /* dot11manufacturerProductVersion DisplayString SIZE(0..128) */
    oal_uint8   auc_dot11manufacturerProductVersion[128];
...
typedef struct {
    ...
    oal_uint32 ul_dot11NonAPStationDroppedHCCAHEMMOctetCount;
    ...
    oal_uint32 ul_dot11NonAPStationDroppedMulticastMSDUCount;
    ...
    oal_uint32 ul_dot11NonAPStationDroppedMulticastOctetCount;
...
typedef struct {
    ...
    oal_uint32          ul_dot11GASQueryRate;                   /* dot11GASQueryRate Gauge32 */
...
typedef struct {
    ...
    wlan_mib_dot11RSNAConfigPairwiseCiphersEntry_stru
        ast_wlan_mib_rsna_cfg_wpa_pairwise_cipher[WLAN_PAIRWISE_CIPHER_SUITES];
    wlan_mib_dot11RSNAConfigPairwiseCiphersEntry_stru
        ast_wlan_mib_rsna_cfg_wpa2_pairwise_cipher[WLAN_PAIRWISE_CIPHER_SUITES];
    ...
    wlan_mib_Dot11RSNAStatsEntry_stru ast_wlan_mib_rsna_status[WLAN_ACTIVE_USER_MAX_NUM *
        WLAN_DEVICE_SUPPORT_MAX_NUM_SPEC + WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE * WLAN_DEVICE_SUPPORT_MAX_NUM_SPEC];
