 ...
 * g_ul_wlan_vap_max_num_per_device 定义和初始化 值均为
 * WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE + WLAN_CONFIG_VAP_MAX_NUM_PER_DEVICE;
 * AP 关联用户的最大个数
 */
...
#if (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1131C_HOST)
/* AP 关联用户的最大个数, c01版本最大设置为4 */
#define WLAN_ASSOC_USER_MAX_NUM_SPEC_C01        4
...
/* AMPDU接收端用于填写BA RX LUT表的win size, 要求大于等于WLAN_AMPDU_RX_BUFFER_SIZE */
...
#define WLAN_HAL_OTHER_BSS_MCAST_DATA_ID         15   /* 来自其他BSS的组播数据帧 */
#endif
...
#define BTCOEX_TIMEOUT_100MS               100
#define BTCOEX_TIMEOUT_10MS                10
#define BTCOEX_TIMEOUT_40MS                40
#define BTCOEX_TIMEOUT_60MS                60

#define BTCOEX_ARP_PRIO_LIMIT              1000

#define BTCOEX_VIP_TYPE_NONE               0
#define BTCOEX_VIP_TYPE_DHCP               1
#define BTCOEX_VIP_TYPE_ARP                2
#define BTCOEX_VIP_TYPE_EAPOL              3
#endif
...
#define COEX_SCO_OCCUP_PERIOD_MS            15
#endif

#endif /* ((_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1131C_DEV) || (_PRE_PRODUCT_ID == _PRE_PRODUCT_ID_HI1131C_HOST)) */
