...
/*****************************************************************************
  2 宏定义
*****************************************************************************/
/* src_ie表示Element ID + Length长度，remain_len表示需要判断参数长度 */
#define MAC_IE_REAMIN_LEN_IS_ENOUGH(src_ie, curr_ie, ie_len, remain_len) \
        (((((curr_ie) - (src_ie)) + (remain_len)) <= (ie_len)) ? OAL_TRUE : OAL_FALSE)
/*****************************************************************************
  3 枚举定义
*****************************************************************************/
