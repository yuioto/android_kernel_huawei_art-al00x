...
typedef enum {
    ...
    /* EMUI对应wpa的枚举发生改变，k3v5的未发生变化，使用编译宏区分 */
...
// 兼容性黑名单芯片厂商识别 chip_oui 目前占位4bit 如果兼容性黑名单数量大于15 chip_oui需要扩位
typedef enum {
    WLAN_AP_CHIP_OUI_NORMAL = 0,
    WLAN_AP_CHIP_OUI_BCM = 1,       /* 芯片厂商为BROADCOM */
    WLAN_AP_CHIP_OUI_RALINK = 2,    /* 芯片厂商为RALINK */
    WLAN_AP_CHIP_OUI_RALINK1 = 3,   /* 芯片厂商为RALINK */
    WLAN_AP_CHIP_OUI_ATHEROS = 4,   /* 芯片厂商为ATHEROS */
    WLAN_AP_CHIP_OUI_QLM = 5,       /* 芯片厂商为QUALCOMM */
    WLAN_AP_CHIP_OUI_SHENZHEN = 6,  /* 芯片厂商为SHENZHEN */
    WLAN_AP_CHIP_OUI_MARVELL = 7,   /* 芯片厂商为MARVELL */
    WLAN_AP_CHIP_OUI_REALTEKS = 8,  /* 芯片厂商为REALTEKS */

    WLAN_AP_CHIP_OUI_BUTT
} wlan_ap_chip_oui_enum;


OAL_STATIC OAL_INLINE oal_uint8 wlan_hdr_get_frame_type(const oal_uint8 *puc_header)
{
