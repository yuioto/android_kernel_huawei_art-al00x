...
extern oal_void hmac_rx_report_eth_frame(mac_vap_stru *pst_mac_vap, oal_netbuf_stru *pst_netbuf);
#endif
extern oal_void hmac_rx_free_netbuf(oal_netbuf_stru *pst_netbuf, oal_uint16 us_nums);
extern oal_void hmac_rx_free_netbuf_list(oal_netbuf_head_stru *pst_netbuf_hdr, oal_uint16 us_nums_buf);
