...
oal_uint32  hmac_wpi_encrypt(const oal_uint8 *puc_iv, oal_uint8 *puc_bufin, oal_uint32 ul_buflen,
                             const oal_uint8 *puc_key, oal_uint8* puc_bufout)
{
    oal_uint32       aul_iv_out[4] = {0};
...
oal_uint32  hmac_wpi_decrypt(const oal_uint8* puc_iv, oal_uint8* puc_bufin, oal_uint32 ul_buflen,
                             const oal_uint8* puc_key, oal_uint8* puc_bufout)
{
...
oal_uint32  hmac_wpi_pmac(const oal_uint8* puc_iv, oal_uint8* puc_buf, oal_uint32 ul_pamclen,
                          const oal_uint8* puc_key, oal_uint8* puc_mic, oal_uint8 uc_mic_len)
{
    oal_uint32  aul_mic_tmp[4] = {0};
    oal_uint32  ul_loop;
    oal_uint32 *pul_in = OAL_PTR_NULL;
    oal_uint32  aul_pr_macKeyin[32] = {0};

    if ((ul_pamclen < 1) || (ul_pamclen > 4096) || (uc_mic_len  == 0)) {
        return OAL_FAIL;
    }
