...
OAL_CONST oal_ieee80211_regdomain_stru *wal_regdb_find_db(const oal_int8 *pc_str)
{
    oal_int32 l_db_idx;
    ...
    for (l_db_idx = 0; l_db_idx < reg_regdb_size; l_db_idx++) {
        if ((pc_str[0] == reg_regdb[l_db_idx]->alpha2[0]) && (pc_str[1] == reg_regdb[l_db_idx]->alpha2[1])) {
