...
typedef enum {
    ...
    OAM_FILE_ID_WAL_APP_C               = 1233,
    OAM_FILE_ID_WAL_LINUX_IOCTL_EXT_C   = 1234,
    OAM_FILE_ID_WAL_LINUX_CFGVENDOR_H   = 1235,
    OAM_FILE_ID_WAL_LINUX_CFGVENDOR_C   = 1236,
    ...
    OAM_FILE_ID_HMAC_BTCOEX_C           = 1398,
    OAM_FILE_ID_HMAC_BTCOEX_H           = 1399,
#endif
    ...
    OAM_FILE_ID_DMAC_DHCP_OFFLOAD_C     = 1523,
    OAM_FILE_ID_DMAC_DHCP_OFFLOAD_H     = 1524,
#ifdef _PRE_WLAN_FEATURE_APF
    OAM_FILE_ID_DMAC_APF_C              = 1525,
    OAM_FILE_ID_DMAC_APF_H              = 1526,
#endif
    ...
    OAM_FILE_ID_OAM_MISC_C                  = 2608,
    OAM_FILE_ID_OAM_MISC_H                  = 2609,

    OAM_FILE_ID_MISC_EXT_IF_H                 = 2610,

    OAM_FILE_ID_LWIP_DATA_C                 = 2700,
    OAM_FILE_ID_DATA_PROC_C                 = 2701,
    OAM_FILE_ID_LIB_API_C                   = 2702,
    /* main_host  mac_host */
    OAM_FILE_ID_MAIN_HOST_C                 = 2703,
    OAM_FILE_ID_MAC_BOARD_HOST_C            = 2704,
    OAM_FILE_ID_MAC_DATA_HOST_C             = 2705,
    OAM_FILE_ID_MAC_DEVICE_HOST_C           = 2706,
    OAM_FILE_ID_MAC_FRAME_HOST_C            = 2707,
    OAM_FILE_ID_MAC_IE_HOST_C               = 2708,
    OAM_FILE_MAC_PM_HOST_C                  = 2709,
    OAM_FILE_ID_MAC_REGDOMAIN_HOST_C        = 2710,
    OAM_FILE_ID_MAC_RESOURCE_HOST_C         = 2711,
    OAM_FILE_ID_MAC_USER_HOST_C             = 2712,
    OAM_FILE_ID_MAC_VAP_HOST_C              = 2713,
    OAM_FILE_ID_BUTT
} oam_file_id_enum;
