...
oal_void  oal_timer_init(oal_timer_list_stru *pst_timer, oal_uint32 ul_delay, oal_timer_func p_func, oal_ulong ui_arg)
{
}
...
oal_int32  oal_timer_start(oal_timer_list_stru *pst_timer, oal_ulong ui_expires)
{
#ifdef  _PRE_WIFI_DMT
...
oal_void _oal_smp_task_lock_(oal_task_lock_stru* pst_lock, uintptr_t claim_addr)
{
    ...
    if (OAL_WARN_ON((uintptr_t)in_interrupt() || in_atomic())) {
