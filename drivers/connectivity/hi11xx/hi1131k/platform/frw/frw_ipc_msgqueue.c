...
{
    frw_ipc_msg_queue_stru *pst_ipc_rx_msg_queue = OAL_PTR_NULL;
                                   ...
                                   oal_uint8 uc_cpuid)
{
    ...
    if (OAL_UNLIKELY((pst_ipc_tx_msg_queue == OAL_PTR_NULL) || pst_msg_input == OAL_PTR_NULL)) {
        OAM_ERROR_LOG0(0, OAM_SF_FRW, "{frw_ipc_msg_queue_send: pst_ipc_tx_msg_queue/pst_msg_input is null ptr}");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  frw_ipc_log_send(frw_ipc_log_stru *pst_log, 
...
oal_uint32  frw_ipc_log_recv(frw_ipc_log_stru *pst_log, 
                             oal_uint16 us_seq_num, 
                             oal_uint8 uc_target_cpuid, 
                             oal_uint8 uc_msg_type)
{
