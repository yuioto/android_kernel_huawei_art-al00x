...
#define WLAN_WAIT_SDIO_POWER_UP         10
#define WLAN_WAIT_FOR_ENTER_DFR         200

#define WLAN_ALLOW_IDLESLEEP            1
#define WLAN_DISALLOW_IDLESLEEP         0
...
struct wlan_pm_s {
    ...
    oal_ulong                ul_wlan_pm_enable;         // pm使能开关
    oal_ulong                ul_wlan_power_state;       // wlan power on state
    oal_ulong                ul_apmode_allow_pm_flag;   /* ap模式下，是否允许下电操作,1:允许,0:不允许 */

    volatile oal_ulong       ul_wlan_dev_state;    // wlan sleep state
    ...
    oal_time_t_stru         ul_slp_time_us;
    ...
    oal_uint32              ul_sleep_fail_count;
...
extern oal_ulong  wlan_pm_exit(oal_void);
...
extern oal_ulong wlan_pm_init_dev(void);
extern oal_ulong wlan_pm_wakeup_dev(oal_void);
extern oal_ulong wlan_pm_wakeup_host(void);
extern oal_ulong  wlan_pm_open_bcpu(oal_void);
extern oal_ulong wlan_pm_state_get(void);
...
extern oal_uint32 wlan_pm_set_pm_sts_exception(oal_void);
...
extern oal_ulong wlan_pm_adjust_feq(void);
