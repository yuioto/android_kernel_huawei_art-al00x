...
typedef struct {
    uint32_t cali_len;
    uint8_t  cali_data[CALI_MAX_LEN];
    uint8_t  saved_flag;
} host_cali_stru;
...
extern void clear_cali_data_buff(void);
extern void *get_cali_data_buf_addr(void);
extern uint8_t api_get_wifi_cali_apply(void);
extern void api_set_wifi_cali_apply(uint8_t permission);
