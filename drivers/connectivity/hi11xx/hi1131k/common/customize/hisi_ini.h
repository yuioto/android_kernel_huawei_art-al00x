...
#define INI_FILE_PATH           (get_ini_file_path_from_dts())
#define DEFAULT_INI_FILE_PATH   FIRMWARE_PATH"/"INI_FILE_NAME
#else
#define INI_FILE_PATH           FIRMWARE_PATH"/"INI_FILE_NAME
#endif
#else
...
#define INI_INIT_MUTEX(mutex)           OAL_MUTEX_INIT(mutex)
#define INI_MUTEX_LOCK(mutex)           oal_mutex_lock(mutex)
#define INI_MUTEX_UNLOCK(mutex)         oal_mutex_unlock(mutex)
...
extern oal_uint8 g_ini_file_name[INI_FILE_PATH_LEN];
...
// 5 Function Declare
#ifdef INI_KO_MODULE
extern oal_int32 ini_find_var_value(oal_int32 modu, oal_int8 *puc_var, oal_int8 *puc_value, oal_uint32 size);
extern oal_int32 get_cust_conf_int32(oal_int32 modu, oal_int8 *puc_var, oal_int32 *pul_value);
extern oal_int32 get_cust_conf_string(oal_int32 modu, oal_int8 *puc_var, oal_int8 *puc_value, oal_uint32 size);
extern oal_int32 set_cust_conf_string(oal_int32 modu, oal_int8 *puc_var, oal_int8 *pc_value);
extern oal_int32 board_ini_find_modu(INI_FILE *fp);
extern oal_int32 board_ini_find_var(INI_FILE *fp, const oal_int8 *puc_var, oal_uint32 *pul_value);
extern oal_int32 ini_cfg_init(void);
extern void ini_cfg_exit(void);
#else
extern oal_int32 ini_find_var_value(oal_int32 modu, oal_int8 *puc_var, oal_int8 *puc_value);
extern oal_int32 get_cust_conf_int32(oal_int32 modu, oal_int8 *puc_var, oal_int32 *pul_value);
extern oal_int32 set_cust_conf_string(oal_int32 modu, oal_int8 *puc_var, oal_int8 *pc_value);
extern oal_int32 get_cust_conf_string(oal_int32 modu, oal_int8 *puc_var, oal_int8 *puc_value);
extern oal_int32 get_run_mode(void);
#endif
