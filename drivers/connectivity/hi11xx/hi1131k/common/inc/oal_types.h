...
/*****************************************************************************
  2 基本数据类型定义
*****************************************************************************/
#ifndef __BITS_PER_OAL_LONG
#define __BITS_PER_OAL_LONG 32
#endif

#if (((_PRE_TEST_MODE_UT == _PRE_TEST_MODE) || (_PRE_TEST_MODE_ST == _PRE_TEST_MODE) || \
...
typedef signed int     oal_ssize_t;
#endif   //_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION


#else
#ifdef CONFIG_ARCH_HI3650
/* 64位操作系统中long 为64bits，当前k3代码中用long long
表示int64,实际字节长度为128bits，需要修改 */
typedef signed long long            oal_int64;          /* 数据前缀:ll */
typedef unsigned long long        oal_uint64;         /* 数据前缀:ull */
#else
typedef signed long               oal_int64;          /* 数据前缀:l */
typedef unsigned long           oal_uint64;         /* 数据前缀:ul */
#endif    // CONFIG_ARCH_HI3650
typedef unsigned long      oal_size_t;
typedef signed long      oal_ssize_t;
#endif   // __BITS_PER_OAL_LONG != 64

typedef unsigned long           oal_ulong;           /* 数据前缀:ui */
typedef signed long             oal_long;            /* 数据前缀:i */
typedef unsigned long           oal_uint;           /* 数据前缀:ui */
typedef signed long             oal_int;            /* 数据前缀:ui */
...
#define BIT30                   ((oal_uint32)(1UL << 30))
#define BIT29                   ((oal_uint32)(1UL << 29))
#define BIT28                   ((oal_uint32)(1UL << 28))
#define BIT27                   ((oal_uint32)(1UL << 27))
#define BIT26                   ((oal_uint32)(1UL << 26))
#define BIT25                   ((oal_uint32)(1UL << 25))
#define BIT24                   ((oal_uint32)(1UL << 24))
#define BIT23                   ((oal_uint32)(1UL << 23))
#define BIT22                   ((oal_uint32)(1UL << 22))
#define BIT21                   ((oal_uint32)(1UL << 21))
#define BIT20                   ((oal_uint32)(1UL << 20))
#define BIT19                   ((oal_uint32)(1UL << 19))
#define BIT18                   ((oal_uint32)(1UL << 18))
#define BIT17                   ((oal_uint32)(1UL << 17))
#define BIT16                   ((oal_uint32)(1UL << 16))
#define BIT15                   ((oal_uint32)(1UL << 15))
#define BIT14                   ((oal_uint32)(1UL << 14))
#define BIT13                   ((oal_uint32)(1UL << 13))
#define BIT12                   ((oal_uint32)(1UL << 12))
#define BIT11                   ((oal_uint32)(1UL << 11))
#define BIT10                   ((oal_uint32)(1UL << 10))
#define BIT9                    ((oal_uint32)(1UL << 9))
#define BIT8                    ((oal_uint32)(1UL << 8))
#define BIT7                    ((oal_uint32)(1UL << 7))
#define BIT6                    ((oal_uint32)(1UL << 6))
#define BIT5                    ((oal_uint32)(1UL << 5))
#define BIT4                    ((oal_uint32)(1UL << 4))
#define BIT3                    ((oal_uint32)(1UL << 3))
#define BIT2                    ((oal_uint32)(1UL << 2))
#define BIT1                    ((oal_uint32)(1UL << 1))
#define BIT0                    ((oal_uint32)(1UL << 0))
#define ALL                     0xFFFF
