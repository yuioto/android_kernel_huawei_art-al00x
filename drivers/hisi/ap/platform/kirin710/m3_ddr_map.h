...
#define M3_DDR_STORAGE_MEM_ADDR (TELE_MNTN_AREA_ADDR + TELE_MNTN_AREA_SIZE)
...
#define M3_DDR_SYS_MEM_ADDR (LPMCU_FIRMWARE_BACKUP_ADDR + LPMCU_FIRMWARE_BACKUP_SIZE)
#define M3_DDR_SYS_MEM_CODE_SEC_ADDR (LPMCU_FIRMWARE_BACKUP_ADDR + LPMCU_FIRMWARE_BACKUP_SIZE)
...
#define UCE_FIRMWARE_BACKUP_ADDR (M3_DDR_SYS_MEM_BSS_SEC_ADDR + M3_DDR_SYS_MEM_BSS_SEC_SIZE)
